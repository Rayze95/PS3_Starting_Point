...
public class MethodLibrary
{
    ...
    public static String toPigLatin (String s)
    {
        ...
        {
            notVowelBeginning = s.substring(firstVowelIndex(s), s.length());
            lettersBeforeVowel = s.substring(0, firstVowelIndex(s));
            return notVowelBeginning + lettersBeforeVowel + "ay";
        }
        else
        {
            return s;
    ...
    public static double sumOfRoots (String numbers, int n)
    {
        ...
        {
            result = result + Math.pow(scn.nextDouble(), 1.0/n);
        }
